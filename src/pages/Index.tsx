...
const SiteCard = ({ site }: { site: SkinSite }) => (
  <a
    ...
    className="flex items-center gap-3 rounded-md border border-border/50 bg-card px-4 py-3 transition-all duration-200 hover:border-primary/40 hover:bg-secondary hover:shadow-[0_0_20px_-5px_hsl(180_100%_40%/0.15)] group"
  >
